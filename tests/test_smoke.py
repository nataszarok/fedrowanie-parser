...
def test_import_core_modules():
    ...
    from fedrowanie_parser.io import storage
    ...
    from fedrowanie_parser.enrichment import (
        attachment_contract, contract_semantic, doctor_initials, doctor_status,
        organizational_unit, person_name, specialization, unit_column,
    )
    from fedrowanie_parser.special_cases import (
        monthly_ledger, multi_contract_columns, section_salary_list,
    )
