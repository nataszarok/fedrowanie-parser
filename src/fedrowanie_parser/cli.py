...
def main() -> None:
    ...
    ap.add_argument('--case-status-csv', default='status_spraw_2025.csv')
    ...
    write_summary(con)
    write_cases_status_csv(con, Path(args.case_status_csv))
    ...
    print(f'DB: {out_db}')
    print(f'Status spraw: {args.case_status_csv}')
